...
class PodcastController extends ApiController
{
     ...
     */
    public function index(PodcastRepository $podcastRepository, SerializerInterface $serializer, Request $request): Response
    {
        $query = $podcastRepository->createQueryBuilder('p');
